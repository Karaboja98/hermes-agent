...
export const de = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      importedBadge: 'Design entfernen',
      pet: {
        title: 'Pet',
        intro:
    ...
    config: {
      ...
      imported: 'Automatisches Speichern fehlgeschlagen',
  ...
  profiles: {
    ...
    deleteDescMid: ' löschen und den',
    deleteDescSuffix: ' Ordner entfernen. Dies kann nicht rückgängig gemacht werden.',
    deleting: 'Lösche...',
  ...
  cron: {
    ...
    deleteDescPrefix: 'Dies wird ',
    deleteDescSuffix: ' dauerhaft entfernen. Sie hört sofort auf zu feuern.',
    deleting: 'Lösche...',
